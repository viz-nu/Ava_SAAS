                        ...
                        switch (command.toLowerCase()) {
                            case 'start':
                                await bot.telegram.sendMessage(
                                    chatId,
                                    `${agent.personalInfo.welcomeMessage}\n Here are some commands you can use:\n
                            ...
                            case 'info':
                                await bot.telegram.sendMessage(chatId, "This is a demo bot showing webhook handling for all message types.");
                                break;

                            default:
                                await bot.telegram.sendMessage(chatId, `Unrecognized command: /${command}. Try /help for a list of commands.`);
                                break;
                        }
                        return;
                    }
